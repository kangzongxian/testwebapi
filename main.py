...
##CONNECT TO DB
#TODO: Create a env variable if you want to upload online for URI

# Use this line of code instead, so that you can prove the blog.db alternative if needed if .get() fails
...
@app.route('/')
def get_all_posts():
    items = getAmazonPrices("water bottle")
